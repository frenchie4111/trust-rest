    ...
    module.exports = function( url ) {
        ...
        var _validateResponseOptions = function( response_options ) {
            ...
            if( response_options.body ) {
                assert.isObject( response_options.body, 'response_options: body should be an object' );
            ...
            request
                .end( function( err, res ) {
                    ...
                    try {
                        ...
                        if( response_options.after_handler ) return response_options.after_handler( err, request, completion_handler );
                        return completion_handler( err );
                    }

                    if( response_options.after_handler ) return response_options.after_handler( null, request, completion_handler );
         ...
         * @param response_options.after_handler {Function} Function to be run after the request function( err, req, done )
